<template>
  <div
    class="flex items-center justify-between p-[17px] w-[800px] h-[138px] rounded-tl-lg rounded-tr-lg border-2 border-gray-200 bg-white cursor-pointer"
    @click="toggle"
  >
    <div class="flex flex-col w-[195px] h-[86.38px] gap-[8px]">
      <div
        class="w-[142.3px] h-[29.38px] rounded-[6.41px] px-[5.19px] py-[8.65px] gap-[17.3px] bg-[#D2FFDA]"
      >
        <div
          class="w-[125px] h-[19px] font-[400] text-[17.3px] leading-[18.82px] text-[#131E41]"
        >
          Órtese de Braço
        </div>
      </div>
      <div class="w-[185px] h-[25px] font-[700] text-[25px] leading-[25px]">
        Silvana Oliveira
      </div>
      <div
        class="w-[195px] h-[16px] font-[700] text-[16px] leading-[16px] text-[#2FB7A0] underline"
      >
        02 ARQUIVOS GERADOS
      </div>
    </div>
    <div class="flex gap-3 items-center">
      <div class="flex w-[204.3px] h-[33.3px] gap-[8px]">
        <Button color="green" text="Download" class="w-[98.15px] h-[33.3px]" />
        <Button color="default" text="imprimir" />
      </div>
      <div class="flex w-[210px] h-[16px] gap-[10px]">
        <div class="flex gap-2 font-[400] text-[16px] leading-[16px]">
          <svg
            width="14"
            height="16"
            viewBox="0 0 15 17"
        ...
        <div
          class="flex gap-2 font-[400] text-[16px] leading-[16px] text-[#2B2B2B]"
        >
          <svg
            width="14"
            height="14"
        ...
        <svg
          :class="{
            'rotate-up': isOpen,
            'rotate-right': !isOpen && hasBeenOpened,
          }"
          width="10"
          height="7"
          viewBox="0 0 10 7"
...
const toggle = () => {
  ...
  if (isOpen.value) {
    hasBeenOpened.value = true; // Mark as opened at least once
  }
};
...
/* Rotate to the right (90 degrees clockwise) when closed */
.rotate-right {
